...
export class CloudflareKVCache extends Cache {
   ...
   * @param _tables - Tables involved in the query (unused in this implementation)
   * @param _isTag - Whether this key is a custom tag (unused in this implementation)
   * @param _isAutoInvalidate - Whether auto-invalidation is enabled (unused in this implementation)
