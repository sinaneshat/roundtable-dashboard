...
export class CloudflareKVCache extends Cache {
   ...
   * @param isTag - Whether this key is a custom tag
   * @param _isAutoInvalidate - Whether auto-invalidation is enabled
   ...
   *
   * @param params - Invalidation parameters (tables and/or tags)
   */
