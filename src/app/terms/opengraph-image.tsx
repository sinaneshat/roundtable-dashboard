/**
 * Static Open Graph Image for Terms of Service Page
...
export const alt = `Terms of Service - ${BRAND.fullName}`;
      ...
      >
        ...
        >
          ...
          >
            ⚖️
            {' '}
            {t('legal.trustBadges.legalCompliance')}
          </div>
          <div
            style={{
              display: 'flex',
        ...
        >
          {t('legal.terms.effectiveYear', { year: 2025 })}
        </div>
      </div>
    ),
    {
