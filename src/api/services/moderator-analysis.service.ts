...
export function buildModeratorSystemPrompt(
  ...
  try {
    ...
    sections.push(
      ...
      '      "suggestedPrompt": "What specific privacy compliance gaps should we address first, and what tools or frameworks would you recommend for conducting a comprehensive privacy audit?",',
      ...
      '        "Beta user feedback indicates 85% satisfaction"',
      '      ],',
      '      "vote": "approve"',
      '    }',
      '  ],',
      ...
      '      {',
      '        "claim": "Market timing is favorable for launch",',
      '        "synthesis": "Strong consensus that Q2 2025 represents optimal market window given regulatory momentum"',
      '      }',
      '    ],',
      '    "evidenceCoverage": [',
      '      {',
      ...
      '    },',
      '    {',
      '      "scenario": "Limited beta launch in Q2",',
      '      "confidence": 71',
      '    }',
      '  ],',
      '',
      ...
      '      "rejected": 0',
      '    },',
      '    "keyThemes": "Board reached 78% confidence decision to caution, citing privacy audit completion as key consideration",',
      '    "unresolvedQuestions": [',
      '      "Can privacy audit be completed within 6-week timeline?",',
      '      "What is acceptable support team capacity threshold?"',
      '    ],',
