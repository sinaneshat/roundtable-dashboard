...
export function buildModeratorSystemPrompt(
  ...
  try {
    ...
    sections.push(
      ...
      '10. **🚨 CRITICAL - ALL PARTICIPANTS MUST BE INCLUDED**:',
      '    - **argumentStrengthProfile**: MUST contain an entry for EVERY participant (use role or model name as key)',
      '    - **agreementHeatmap**: EVERY claim\'s perspectives object MUST include ALL participants',
      '    - If there are 3 participants, you MUST have 3 entries in argumentStrengthProfile',
      '    - If there are 5 participants, you MUST have 5 entries in argumentStrengthProfile',
      '    - NEVER omit any participant from these sections',
      '11. **Recommendations with Actionable Prompts**: Each recommendation MUST include:',
