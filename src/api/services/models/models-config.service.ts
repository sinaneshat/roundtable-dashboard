...
export const HARDCODED_MODELS: readonly HardcodedModel[] = [
  {
    ...
    provider: 'openai',
    category: 'general',
    capabilities: { vision: false, file: false, reasoning: true, streaming: true, tools: true },
  ...
  },
  {
    ...
    capabilities: { vision: true, file: true, reasoning: true, streaming: true, tools: true },
  ...
  },
  {
    ...
    provider: 'openai',
    category: 'general',
    capabilities: { vision: true, file: true, reasoning: false, streaming: true, tools: true },
  ...
  },
  {
    ...
    provider: 'openai',
    category: 'general',
    capabilities: { vision: true, file: false, reasoning: false, streaming: true, tools: true },
  ...
  },
  {
    ...
    provider: 'x-ai',
    category: 'general',
    capabilities: { vision: true, file: false, reasoning: true, streaming: true, tools: true },
  ...
  },
  {
    ...
    created: 1742860800,
    pricing: { prompt: '0.00000019', completion: '0.00000087' },
    ...
    provider: 'deepseek',
    category: 'general',
    capabilities: { vision: false, file: false, reasoning: false, streaming: true, tools: true },
