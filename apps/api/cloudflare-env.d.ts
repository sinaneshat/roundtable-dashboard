/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 58703ce075399650897830c8775a438f)
// Runtime types generated with workerd@1.20260116.0 2026-01-20 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "UploadCleanupScheduler";
	}
	interface Env {
		KV: KVNamespace;
		WEBAPP_ENV: "local" | "preview" | "prod";
		APP_NAME: "Roundtable API";
		TURNSTILE_SITE_KEY: "0x4AAAAAACN3_OeMcDjErTqV";
		R2_PUBLIC_URL: "http://localhost:8787/uploads" | "https://api-preview.roundtable.now/uploads" | "https://api.roundtable.now/uploads";
		...
		BETTER_AUTH_URL: "http://localhost:8787" | "https://api-preview.roundtable.now" | "https://api.roundtable.now";
		...
		POSTHOG_HOST: string;
		UPLOAD_CLEANUP_SCHEDULER: DurableObjectNamespace /* UploadCleanupScheduler from roundtable-api */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAPP_ENV" | "APP_NAME" | "TURNSTILE_SITE_KEY" | "R2_PUBLIC_URL" | "SES_VERIFIED_EMAIL" | "STRIPE_CUSTOMER_PORTAL_CONFIG_ID" | "STRIPE_PUBLISHABLE_KEY" | "AUTH_GOOGLE_ID" | "BETTER_AUTH_URL" | "NODE_ENV" | "BETTER_AUTH_SECRET" | "AUTH_GOOGLE_SECRET" | "TURNSTILE_SECRET_KEY" | "AWS_SES_ACCESS_KEY_ID" | "AWS_SES_SECRET_ACCESS_KEY" | "AWS_SES_REGION" | "FROM_EMAIL" | "SES_REPLY_TO_EMAIL" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "OPENROUTER_API_KEY" | "POSTHOG_API_KEY" | "POSTHOG_HOST">> {}
}
declare module "*.wasm" {
