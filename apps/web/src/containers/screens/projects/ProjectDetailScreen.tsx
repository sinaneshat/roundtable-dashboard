import { ComponentVariants, DEFAULT_PROJECT_COLOR, DEFAULT_PROJECT_ICON } from '@roundtable/shared';
...
import { useThreadNavigation } from '@/hooks/utils';
...
export function ProjectDetailScreen({
  ...
  // Open settings modal from URL param
  useEffect(() => {
