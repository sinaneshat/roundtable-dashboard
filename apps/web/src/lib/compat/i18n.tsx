...
export async function getTranslations(namespace?: string): Promise<TranslationFunction> {
  // For now, just return the client-side implementation
  // In a real implementation, this would load translations server-side
...
// Formats type for i18n configuration
export type Formats = {
...
// Request config function type for SSR i18n setup
type RequestConfig = {
  locale: string;
  messages: Messages;
  formats?: Formats;
