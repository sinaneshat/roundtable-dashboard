    ...
    <div style={cardStyles}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
        ...
        {isSelected && (
          ...
          >
            <svg width={12} height={12} viewBox="0 0 24 24" fill="none" stroke={TEXT.primary} strokeWidth={3}>
...
export function SceneModelModal() {
  ...
  const getLabelText = () => {
    if (frame < PHASE.tabSwitch.start)
      return 'Quick presets for common tasks';
    if (frame < PHASE.dragReorder.start)
      return 'Or customize your panel';
    if (frame < PHASE.roleAssign.start)
      return 'Drag to set priority order';
    return 'Assign roles to specialize each model';
  };
    ...
    >
      ...
      <div
        style={{
          ...
          top: 60,
          left: 60,
          opacity: labelOpacity * finalModalOpacity,
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              border: isSelected ? '1px solid rgba(168, 85, 247, 0.4)' : '1px solid rgba(255, 255, 255, 0.1)',
                              color: isSelected ? 'rgb(196, 181, 253)' : TEXT.muted,
                            }}
                          >
                            <CapabilityIcon type={tag.icon} color={isSelected ? 'rgb(196, 181, 253)' : TEXT.muted} />
                            {tag.label}
                          </div>
                        );
                      })}
                            ...
                            >
                              ...
                              <div
                                style={{
                                  ...
                                  height: 22,
                                  borderRadius: 9999,
                                  backgroundColor: model.selected ? 'rgb(168, 85, 247)' : '#3a3a3a',
                                  position: 'relative',
                                  flexShrink: 0,
                                }}
                              >
