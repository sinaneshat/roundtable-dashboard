        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              'img-src \'self\' data: blob: https://*.posthog.com https://lh3.googleusercontent.com https://lh4.googleusercontent.com https://lh5.googleusercontent.com https://lh6.googleusercontent.com https://googleusercontent.com',
              `connect-src 'self' ${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'} https://*.posthog.com wss://*.posthog.com`,
              'worker-src \'self\' blob:',
