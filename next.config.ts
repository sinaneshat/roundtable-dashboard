        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              'style-src \'self\' \'unsafe-inline\' https://us.posthog.com',
              ...
              `connect-src 'self' ${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'} https://us.i.posthog.com https://us-assets.i.posthog.com https://us.posthog.com https://internal-j.posthog.com`,
              'worker-src \'self\' blob:',
              'frame-ancestors \'none\'',
              'base-uri \'self\'',
              'form-action \'self\'',
