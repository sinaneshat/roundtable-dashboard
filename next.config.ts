        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              'img-src \'self\' data: blob: https://*.posthog.com https://*.i.posthog.com https://lh3.googleusercontent.com https://lh4.googleusercontent.com https://lh5.googleusercontent.com https://lh6.googleusercontent.com https://googleusercontent.com',
              `connect-src 'self' ${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'} https://*.posthog.com https://*.i.posthog.com wss://*.posthog.com wss://*.i.posthog.com`,
              'worker-src \'self\' blob: https://*.posthog.com https://*.i.posthog.com',
              'font-src \'self\' data: https://*.posthog.com https://*.i.posthog.com',
              'frame-src \'self\' https://*.posthog.com https://*.i.posthog.com',
              'frame-ancestors \'none\'',
              'base-uri \'self\'',
              'form-action \'self\'',
            ].join('; '),
