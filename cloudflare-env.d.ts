/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: bc8a81b05b27db868a0dbbe72ce08e70)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_USE_DEV_MODELS: string;
