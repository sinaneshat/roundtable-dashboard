/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 93eb5702033d6a7a1864247e784912e1)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DOQueueHandler" | "BucketCachePurge" | "UploadCleanupScheduler" | "DOShardedTagCache";
	}
	interface Env {
		KV: KVNamespace;
		...
		OPENNEXT_DEBUG: string;
		NEXT_DEBUG: string;
		VERBOSE: string;
		LOG_LEVEL: string;
		MINIFLARE_LOG_LEVEL: string;
		...
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace /* DOShardedTagCache from roundtable-dashboard */;
