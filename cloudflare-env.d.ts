/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: be71bc0ba615738183829dc8edf679e0)
// Runtime types generated with workerd@1.20251210.0 2025-11-06 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "DOQueueHandler" | "BucketCachePurge" | "UploadCleanupScheduler";
	}
	interface Env {
		KV: KVNamespace;
		...
		NEXT_PUBLIC_AWS_SES_REGION: string;
		NEXT_PUBLIC_FROM_EMAIL: string;
		NEXT_PUBLIC_SES_REPLY_TO_EMAIL: string;
		NEXT_PUBLIC_SES_VERIFIED_EMAIL: string;
		...
		NEXT_PUBLIC_STRIPE_CUSTOMER_PORTAL_CONFIG_ID: string;
		STRIPE_WEBHOOK_SECRET: string;
		OPENROUTER_API_KEY: string;
		NEXT_PUBLIC_POSTHOG_API_KEY: string;
		NEXT_PUBLIC_POSTHOG_HOST: string;
		OPEN_NEXT_DEBUG: string;
		NODE_VERSION: string;
		PNPM_VERSION: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		D1_TOKEN: string;
		PREVIEW_DATABASE_ID: string;
		PROD_DATABASE_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace<import("./custom-worker").DOQueueHandler>;
		NEXT_CACHE_DO_PURGE: DurableObjectNamespace<import("./custom-worker").BucketCachePurge>;
		UPLOAD_CLEANUP_SCHEDULER: DurableObjectNamespace<import("./custom-worker").UploadCleanupScheduler>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NODE_ENV" | "NEXT_PUBLIC_WEBAPP_ENV" | "NEXT_PUBLIC_APP_URL" | "NEXT_PUBLIC_API_URL" | "NEXT_PUBLIC_APP_NAME" | "NEXT_PUBLIC_APP_VERSION" | "NEXT_PUBLIC_MAINTENANCE" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "NEXT_PUBLIC_R2_PUBLIC_URL" | "AWS_SES_ACCESS_KEY_ID" | "AWS_SES_SECRET_ACCESS_KEY" | "NEXT_PUBLIC_AWS_SES_REGION" | "NEXT_PUBLIC_FROM_EMAIL" | "NEXT_PUBLIC_SES_REPLY_TO_EMAIL" | "NEXT_PUBLIC_SES_VERIFIED_EMAIL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "STRIPE_SECRET_KEY" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "NEXT_PUBLIC_STRIPE_CUSTOMER_PORTAL_CONFIG_ID" | "STRIPE_WEBHOOK_SECRET" | "OPENROUTER_API_KEY" | "NEXT_PUBLIC_POSTHOG_API_KEY" | "NEXT_PUBLIC_POSTHOG_HOST" | "OPEN_NEXT_DEBUG" | "NODE_VERSION" | "PNPM_VERSION" | "CLOUDFLARE_ACCOUNT_ID" | "D1_TOKEN" | "PREVIEW_DATABASE_ID" | "PROD_DATABASE_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
