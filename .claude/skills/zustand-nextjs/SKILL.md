---
name: zustand-nextjs
description: Enforce Zustand v5 state management patterns with Next.js App Router, including SSR hydration, store factories, Context providers, and React 19 compatibility. Use when implementing stores, fixing hydration issues, or setting up state management.
allowed-tools: Read, Grep, Glob, Edit, Write
---

# Zustand v5 + Next.js Patterns
...
**Fetch latest docs:** Use `mcp__context7__get-library-docs` with topics like "nextjs hydration", "persist", "createStore context"
